...
// Single source of truth for main navigation. Both the desktop sidebar
// (Layout) and the mobile drawer (NavigationDrawer) render from these lists —
// add/reorder items here, never in the components, so the two surfaces
...
// Consumption first (Inbox is the daily entry point), then the library.
...
// Operator-only pipeline views, hidden for non-admins (multi-user mode).
export const ADMIN_NAV_ITEMS: NavEntry[] = [
  { to: '/status', label: 'Status', icon: statusIcon },
  { to: '/queue', label: 'Task Queue', icon: queueIcon },
  { to: '/failed', label: 'Failed Tasks', icon: failedIcon },
]
