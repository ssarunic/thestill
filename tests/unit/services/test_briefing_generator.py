...
Tests the briefing generation from processed episodes.
"""
...
from thestill.services.briefing_generator import BriefingContent, BriefingEpisodeInfo, BriefingGenerator, BriefingStats
...
class TestBriefingStats:
    """Tests for BriefingStats dataclass."""
    ...
    def test_success_rate_zero_episodes(self):
        ...
        stats = BriefingStats(total_episodes=0)
...
class TestBriefingGeneratorExtraction:
    ...
    def test_extract_executive_summary_with_emoji(self, mock_path_manager, mock_file_storage):
        ...
        generator = BriefingGenerator(mock_path_manager, mock_file_storage)
...
class TestBriefingGeneratorGenerate:
    ...
    def test_generate_empty_list(self, mock_path_manager, mock_file_storage):
        """Generate briefing with empty episode list."""
        generator = BriefingGenerator(mock_path_manager, mock_file_storage)
    ...
    def test_generate_with_episodes(self, mock_path_manager, mock_file_storage, sample_podcast):
        """Generate briefing with episodes."""
    ...
    def test_generate_with_failures(self, mock_path_manager, mock_file_storage, sample_podcast):
        """Generate briefing with failed episodes."""
    ...
    def test_generate_with_processing_time(self, mock_path_manager, mock_file_storage, sample_podcast):
        """Generate briefing with processing time."""
...
class TestBriefingGeneratorWrite:
    """Tests for briefing file writing — uses a real LocalFileStorage rooted at
...
class TestBriefingGeneratorFormatting:
