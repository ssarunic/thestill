...
| 21 | [episode-processing-indicator](21-episode-processing-indicator.md) | 📋 Planned (2026-04-19) | Show "currently processing" badge on episode cards in lists; frontend-only via queue-tasks hook |
